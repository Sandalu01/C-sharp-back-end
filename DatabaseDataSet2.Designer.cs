...
namespace LAB_07 {
    ...
    public partial class DatabaseDataSet2 : global::System.Data.DataSet {
        ...
        public partial class BookDataTable : global::System.Data.TypedTableBase<BookRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")]
            public BookRow AddBookRow(int Id, string Title, string ISBN) {
...
namespace LAB_07.DatabaseDataSet2TableAdapters {
    ...
    public partial class BookTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = "DELETE FROM [dbo].[Book] WHERE (([Id] = @Original_Id) AND ((@IsNull_Title = 1 AND" +
                " [Title] IS NULL) OR ([Title] = @Original_Title)) AND ((@IsNull_ISBN = 1 AND [IS" +
                "BN] IS NULL) OR ([ISBN] = @Original_ISBN)))";
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO [dbo].[Book] ([Id], [Title], [ISBN]) VALUES (@Id, @Title, @ISBN);\r\nSE" +
                "LECT Id, Title, ISBN FROM Book WHERE (Id = @Id)";
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [dbo].[Book] SET [Id] = @Id, [Title] = @Title, [ISBN] = @ISBN WHERE (([Id] = @Original_Id) AND ((@IsNull_Title = 1 AND [Title] IS NULL) OR ([Title] = @Original_Title)) AND ((@IsNull_ISBN = 1 AND [ISBN] IS NULL) OR ([ISBN] = @Original_ISBN)));
SELECT Id, Title, ISBN FROM Book WHERE (Id = @Id)";
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT Id, Title, ISBN FROM dbo.Book";
        ...
        public virtual int Fill(DatabaseDataSet2.BookDataTable dataTable) {
        ...
        public virtual DatabaseDataSet2.BookDataTable GetData() {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            DatabaseDataSet2.BookDataTable dataTable = new DatabaseDataSet2.BookDataTable();
        ...
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")]
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        public virtual int Update(DatabaseDataSet2.BookDataTable dataTable) {
        ...
        public virtual int Delete(int Original_Id, string Original_Title, string Original_ISBN) {
        ...
        public virtual int Insert(int Id, string Title, string ISBN) {
        ...
        public virtual int Update(int Id, string Title, string ISBN, int Original_Id, string Original_Title, string Original_ISBN) {
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(string Title, string ISBN, int Original_Id, string Original_Title, string Original_ISBN) {
            return this.Update(Original_Id, Title, ISBN, Original_Id, Original_Title, Original_ISBN);
        }
    }
