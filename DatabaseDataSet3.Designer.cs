...
namespace LAB_07 {
    ...
    public partial class DatabaseDataSet3 : global::System.Data.DataSet {
        ...
        public partial class EmployeeDataTable : global::System.Data.TypedTableBase<EmployeeRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")]
            public EmployeeRow AddEmployeeRow(int Id, string FirstName, float Salary) {
...
namespace LAB_07.DatabaseDataSet3TableAdapters {
    ...
    public partial class EmployeeTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = "DELETE FROM [dbo].[Employee] WHERE (([Id] = @Original_Id) AND ((@IsNull_FirstName" +
                ...
                "ull_Salary = 1 AND [Salary] IS NULL) OR ([Salary] = @Original_Salary)))";
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO [dbo].[Employee] ([Id], [FirstName], [Salary]) VALUES (@Id, @FirstNam" +
                "e, @Salary);\r\nSELECT Id, FirstName, Salary FROM Employee WHERE (Id = @Id)";
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [dbo].[Employee] SET [Id] = @Id, [FirstName] = @FirstName, [Salary] = @Salary WHERE (([Id] = @Original_Id) AND ((@IsNull_FirstName = 1 AND [FirstName] IS NULL) OR ([FirstName] = @Original_FirstName)) AND ((@IsNull_Salary = 1 AND [Salary] IS NULL) OR ([Salary] = @Original_Salary)));
SELECT Id, FirstName, Salary FROM Employee WHERE (Id = @Id)";
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT Id, FirstName, Salary FROM dbo.Employee";
        ...
        public virtual int Fill(DatabaseDataSet3.EmployeeDataTable dataTable) {
        ...
        public virtual DatabaseDataSet3.EmployeeDataTable GetData() {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            DatabaseDataSet3.EmployeeDataTable dataTable = new DatabaseDataSet3.EmployeeDataTable();
        ...
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")]
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        public virtual int Update(DatabaseDataSet3.EmployeeDataTable dataTable) {
        ...
        public virtual int Delete(int Original_Id, string Original_FirstName, global::System.Nullable<float> Original_Salary) {
            ...
            if ((Original_Salary.HasValue == true)) {
                ...
                this.Adapter.DeleteCommand.Parameters[4].Value = ((float)(Original_Salary.Value));
            }
            else {
        ...
        public virtual int Insert(int Id, string FirstName, global::System.Nullable<float> Salary) {
        ...
        public virtual int Update(int Id, string FirstName, global::System.Nullable<float> Salary, int Original_Id, string Original_FirstName, global::System.Nullable<float> Original_Salary) {
            ...
            if ((Original_Salary.HasValue == true)) {
                ...
                this.Adapter.UpdateCommand.Parameters[7].Value = ((float)(Original_Salary.Value));
            }
            else {
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(string FirstName, global::System.Nullable<float> Salary, int Original_Id, string Original_FirstName, global::System.Nullable<float> Original_Salary) {
            return this.Update(Original_Id, FirstName, Salary, Original_Id, Original_FirstName, Original_Salary);
        }
    }
